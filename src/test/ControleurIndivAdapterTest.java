...
public class ControleurIndivAdapterTest extends TestCase {
	...
	/*
	 * on vérifie que la valeur propre stockée est bien celle qui a été créée
	 * initialement
	 */
	...
	/*
	 * On vérifie à l'issue du croisement que le nouvel individu n'est pas égal
	 * à l'original
	 */
	public void testCroiser() {
		autre = cia.croiser(autre);
