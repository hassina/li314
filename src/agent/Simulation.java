...
/**
 * Cette classe représente un agent qui se déplace dans un labyrinthe.
 * 
 * @author sigaud
 */
public class Simulation extends SimpleObservable {
	...
	/**
	 * Le labyrinthe dans lequel la simulation se déroule. Attention, ce
	 * labyrinthe est modifié au cours de la simulation.
	 */
	private Labyrinthe laby;

	/**
	 * Constructeur : initialise une simulation d'un contrôleur donné dans un
	 * labyrinthe donné.
	 * 
	 * @param m
	 *            : le labyrinthe, sera modifié par la simulation
	 * @param c
	 *            : le controleur
	 */
