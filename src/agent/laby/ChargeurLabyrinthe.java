 ...
 * 
 * Une méthode s'appuie sur la sérialisation {@link Serializable}. L'autre sur
 * un format XML (sortie OK, entrée non disponible).
 * 
 * @author sigaud, Yann
 */
public class ChargeurLabyrinthe {
	 ...
	 */
	public static Labyrinthe chargerLabyrinthe(String fileName)
			throws IOException {
		...
		try {
			...
			System.out.println("Correction du labyrinthe : "
	 ...
	 * 
	 * Lève l'exception standard "unsupported" ! Evitez de faire cela en
	 * général.
	 * 
	 * @throws IOException
	 */
