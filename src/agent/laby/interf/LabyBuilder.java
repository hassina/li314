...
public class LabyBuilder extends JFrame {
	...
	// des constantes plutôt que des String en litéral "Toto" enfouies dans le
	// code.
	...
	// Pour les tests getSource dans le Menu Listener : les sources d'événements
	// menu
	...
	/**
	 * Créée les menus d'import export et y associe le traitement défini par
	 * MenuListener.
	 */
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				JOptionPane.showInternalMessageDialog(getFrame(),
						e1.getMessage(), "Error during export ",
	...
	public void exportMazeData() throws IOException {
		// Force la remise à jour de l'état du labyrinthe en fonction des
		// boutons
