...
/**
 * 
 * Un panel {@link JPanel} pour dessiner un maze {@link Labyrinthe}. Les
 * cellules {@link CaseButton} sont clickable, ce qui change leur aspect et
 * modifie le Maze sous-jacent. L'effet du clic sur la cellule est détérminé par
...
public class LabyPanel extends JPanel implements ActionListener {
	...
	/**
	 * Force la synchronisation en écrivant l'état des boutons dans le
	 * labyrinthe sous-jacent. NB: En principe, le labyrinthe et les boutons
	 * sont déjà synchronisés, chaque appui de bouton étant immédiatement
	 * appliqué au labyrinthe (cf. corps de actionPerformed).
	 */
	 ...
	 *            l'action donne le nouveau contenu à appliquer à la cellule
	 */
