 ...
 * 
 * 
 * * Les controleurs utilisent une base de règles basées sur la reconnaissance
 * d'un motif autour de l'agent.
 * 
 * On crée des Observation basés sur une chaine de caractères composée de 8
 * caractère : # : mur, ? : ANY, . : point, ' ' : vide, A : Agent
 * 
 * Les caractères sont interprétés dans la convention horaire: 0 = Nord, 1 = NE,
 * 2 = E, 3 = SE, 4 = S, 5 = SO, 6 = O, 7 = NO
 * 
 * @author Yann
 * 
 */
